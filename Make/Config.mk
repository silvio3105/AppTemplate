...
# DIRECTORY WITH MCU FILES
DIR_MCU = MCU/$(MCU_NAME)

# DIRECTORY WITH RTOS FILES
DIR_RTOS = RTOS/$(RTOS_NAME)

# DIRECTORY WITH LINKER SCRIPT
DIR_LINKER = $(DIR_MCU)/Linker

# DIRECTORY WITH STARTUP FILE
DIR_STARTUP = $(DIR_MCU)/Startup
...
JLINK_FLASH = .jlink\JLink_Flash_$(BUILD_NAME).jlink
JLINK_ERASE = .jlink\JLink_Erase_$(BUILD_NAME).jlink
JLINK_ERASE_ALL = .jlink\JLink_EraseAll_$(BUILD_NAME).jlink
JLINK_RESET = .jlink\JLink_Reset_$(BUILD_NAME).jlink
